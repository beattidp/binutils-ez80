/* BFD back-end for Zilog EZ80 COFF binaries.
...
#define BADMAG(x) EZ80BADMAG(x)
#define EZ80 1			/* Customize coffcode.h.  */
...
coff_ez80_reloc_type_lookup (bfd *abfd ATTRIBUTE_UNUSED,
			    bfd_reloc_code_real_type code)
{
  switch (code)
    ...
    case BFD_RELOC_EZ80_DISP8:	return & r_off8;
    default:			BFD_FAIL ();
      return NULL;
    }
}
...
static reloc_howto_type *
coff_ez80_reloc_name_lookup (bfd *abfd ATTRIBUTE_UNUSED,
			    const char *r_name)
{
...
#define coff_bfd_reloc_type_lookup  coff_ez80_reloc_type_lookup
#define coff_bfd_reloc_name_lookup coff_ez80_reloc_name_lookup
...
CREATE_LITTLE_COFF_TARGET_VEC (ez80coff_vec, "coff-ez80", 0,
