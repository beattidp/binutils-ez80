...
/* Hash table initialization and handling.  Code is taken from the AVR port
   and adapted to the needs of eZ80.  */

/* We use two hash tables to hold information for linking ez80 objects.

   The first is the elf32_ez80_link_hash_table which is derived from the
...
struct elf32_ez80_stub_hash_entry
{
...
struct elf32_ez80_link_hash_table
{
  /* The main hash table.  */
  ...
  /* Usually 0, unless we are generating code for a bootloader.  Will
     be initialized by elf32_ez80_size_stubs to the vma offset of the
     output section associated with the stub section.  */
  bfd_vma vector_base;

  /* Assorted information used by elf32_ez80_size_stubs.  */
...
#define ez80_link_hash_table(p) \
  /* PR 3874: Check that we have an EZ80 style hash table before using it.  */\
  (elf_hash_table_id ((struct elf_link_hash_table *) ((p)->hash)) \
  == EZ80_ELF_DATA ? ((struct elf32_ez80_link_hash_table *) ((p)->hash)) : NULL)

#define ez80_stub_hash_entry(ent) \
  ((struct elf32_ez80_stub_hash_entry *)(ent))

#define ez80_stub_hash_lookup(table, string, create, copy) \
  ((struct elf32_ez80_stub_hash_entry *) \
   bfd_hash_lookup ((table), (string), (create), (copy)))

static reloc_howto_type elf_ez80_howto_table[] =
{
  HOWTO (R_EZ80_NONE,    /* type */
    0,         /* rightshift */
  ...
  /* A low 8 bit absolute relocation of 24 bit program memory address.
     For LDI command.  Will not be changed when linker stubs are needed. */
  HOWTO (R_EZ80_LO8_LDI_PM_NEG,   /* type */
    1,         /* rightshift */
    1,         /* size (0 = byte, 1 = short, 2 = long) */
    8,         /* bitsize */
    false,        /* pc_relative */
  ...
  /* A low 8 bit absolute relocation of 24 bit program memory address.
     For LDI command.  Will not be changed when linker stubs are needed. */
  HOWTO (R_EZ80_HI8_LDI_PM_NEG,   /* type */
    9,         /* rightshift */
    1,         /* size (0 = byte, 1 = short, 2 = long) */
    8,         /* bitsize */
    false,        /* pc_relative */
  ...
  /* A low 8 bit absolute relocation of 24 bit program memory address.
     For LDI command.  Will not be changed when linker stubs are needed. */
  HOWTO (R_EZ80_HH8_LDI_PM_NEG,   /* type */
    17,        /* rightshift */
    1,         /* size (0 = byte, 1 = short, 2 = long) */
    8,         /* bitsize */
    false,        /* pc_relative */
    ...
    complain_overflow_dont, /* complain_on_overflow */
    bfd_elf_generic_reloc, /* special_function */
    "R_EZ80_HH8_LDI_PM_NEG", /* name */
    false,        /* partial_inplace */
    0xffff,    /* src_mask */
    0xffff,    /* dst_mask */
    false),    /* pcrel_offset */
  /* Relocation for CALL command in ATmega.  */
  HOWTO (R_EZ80_CALL,    /* type */
    1,         /* rightshift */
    2,         /* size (0 = byte, 1 = short, 2 = long) */
    23,        /* bitsize */
    false,        /* pc_relative */
  ...
  HOWTO (R_EZ80_8_HLO8,     /* type */
    ...
    false),    /* pcrel_offset */
  /**
   * @brief Relocation HOWTO for 24-bit absolute address.
   */
  HOWTO (R_EZ80_24,       /* type */
    0,         /* rightshift */
    2,         /* size (0 = byte, 1 = short, 2 = long) */
    24,        /* bitsize */
    false,     /* pc_relative */
    ...
    false),    /* pcrel_offset */
  /**
   * @brief Relocation HOWTO for 8-bit PC-relative offset.
   */
  HOWTO (R_EZ80_8_PCREL,  /* type */
    0,         /* rightshift */
    0,         /* size (0 = byte, 1 = short, 2 = long) */
    8,         /* bitsize */
    true,      /* pc_relative */
    ...
    true),     /* pcrel_offset */
  /**
   * @brief Relocation HOWTO for 8-bit index register displacement offset.
   */
  HOWTO (R_EZ80_DISP8,    /* type */
    0,         /* rightshift */
    0,         /* size (0 = byte, 1 = short, 2 = long) */
    8,         /* bitsize */
    false,     /* pc_relative */
...
/* Map BFD reloc types to EZ80 ELF reloc types.  */

struct ez80_reloc_map
{
  bfd_reloc_code_real_type bfd_reloc_val;
  unsigned int elf_reloc_val;
};

static const struct ez80_reloc_map ez80_reloc_map[] =
{
  { BFD_RELOC_NONE,                 R_EZ80_NONE },
  { BFD_RELOC_32,                   R_EZ80_32 },
#if 0
  { BFD_RELOC_EZ80_7_PCREL,          R_EZ80_7_PCREL },
  { BFD_RELOC_EZ80_13_PCREL,         R_EZ80_13_PCREL },
#endif
  { BFD_RELOC_16,                   R_EZ80_16 },
#if 0
  { BFD_RELOC_EZ80_16_PM,            R_EZ80_16_PM },
  { BFD_RELOC_EZ80_LO8_LDI,          R_EZ80_LO8_LDI},
  { BFD_RELOC_EZ80_HI8_LDI,          R_EZ80_HI8_LDI },
  { BFD_RELOC_EZ80_HH8_LDI,          R_EZ80_HH8_LDI },
  { BFD_RELOC_EZ80_MS8_LDI,          R_EZ80_MS8_LDI },
  { BFD_RELOC_EZ80_LO8_LDI_NEG,      R_EZ80_LO8_LDI_NEG },
  { BFD_RELOC_EZ80_HI8_LDI_NEG,      R_EZ80_HI8_LDI_NEG },
  { BFD_RELOC_EZ80_HH8_LDI_NEG,      R_EZ80_HH8_LDI_NEG },
  { BFD_RELOC_EZ80_MS8_LDI_NEG,      R_EZ80_MS8_LDI_NEG },
  { BFD_RELOC_EZ80_LO8_LDI_PM,       R_EZ80_LO8_LDI_PM },
  { BFD_RELOC_EZ80_LO8_LDI_GS,       R_EZ80_LO8_LDI_GS },
  { BFD_RELOC_EZ80_HI8_LDI_PM,       R_EZ80_HI8_LDI_PM },
  { BFD_RELOC_EZ80_HI8_LDI_GS,       R_EZ80_HI8_LDI_GS },
  { BFD_RELOC_EZ80_HH8_LDI_PM,       R_EZ80_HH8_LDI_PM },
  { BFD_RELOC_EZ80_LO8_LDI_PM_NEG,   R_EZ80_LO8_LDI_PM_NEG },
  { BFD_RELOC_EZ80_HI8_LDI_PM_NEG,   R_EZ80_HI8_LDI_PM_NEG },
  { BFD_RELOC_EZ80_HH8_LDI_PM_NEG,   R_EZ80_HH8_LDI_PM_NEG },
  { BFD_RELOC_EZ80_CALL,             R_EZ80_CALL },
  { BFD_RELOC_EZ80_LDI,              R_EZ80_LDI  },
  { BFD_RELOC_EZ80_6,                R_EZ80_6    },
  { BFD_RELOC_EZ80_6_ADIW,           R_EZ80_6_ADIW },
  { BFD_RELOC_8,                    R_EZ80_8 },
  { BFD_RELOC_EZ80_8_LO,             R_EZ80_8_LO8 },
  { BFD_RELOC_EZ80_8_HI,             R_EZ80_8_HI8 },
  { BFD_RELOC_EZ80_8_HLO,            R_EZ80_8_HLO8 }
#endif
  { BFD_RELOC_8,                    R_EZ80_8 },
  { BFD_RELOC_24,                   R_EZ80_24 },
  { BFD_RELOC_8_PCREL,              R_EZ80_8_PCREL },
  { BFD_RELOC_Z80_DISP8,            R_EZ80_DISP8 }
};
...
/* Meant to be filled one day with the wrap around address for the
   ...
   ez80_pc_wrap_around one single bit is set.  */
static bfd_vma ez80_pc_wrap_around = 0x10000000;
...
static int ez80_replace_call_ret_sequences = 1;
                   ...
                   const char *string)
{
  ...
  if (entry != NULL)
    {
      struct elf32_ez80_stub_hash_entry *hsh;

      /* Initialize the local fields.  */
      hsh = ez80_stub_hash_entry (entry);
      hsh->stub_offset = 0;
      hsh->target_value = 0;
    }
...
/* This function is just a straight passthrough to the real
   ...
   can be compared inside the ez80_link_hash_table macro.  */

static struct bfd_hash_entry *
elf32_ez80_link_hash_newfunc (struct bfd_hash_entry * entry,
              struct bfd_hash_table * table,
              const char * string)
{
...
/* Create the derived linker hash table.  The EZ80 ELF port uses the derived
...
static int
ez80_relative_distance_considering_wrap_around (unsigned int distance)
{
  unsigned int wrap_around_mask = ez80_pc_wrap_around - 1;
  int dist_with_wrap_around = distance & wrap_around_mask;

  if (dist_with_wrap_around > ((int) (ez80_pc_wrap_around >> 1)))
    dist_with_wrap_around -= ez80_pc_wrap_around;
             ...
             bfd_reloc_code_real_type code)
{
  ...
  for (i = 0;
       i < sizeof (ez80_reloc_map) / sizeof (struct ez80_reloc_map);
       i++)
    if (ez80_reloc_map[i].bfd_reloc_val == code)
      return &elf_ez80_howto_table[ez80_reloc_map[i].elf_reloc_val];
             ...
             const char *r_name)
{
  ...
  for (i = 0;
       i < sizeof (elf_ez80_howto_table) / sizeof (elf_ez80_howto_table[0]);
       i++)
    if (elf_ez80_howto_table[i].name != NULL
   && strcasecmp (elf_ez80_howto_table[i].name, r_name) == 0)
      return &elf_ez80_howto_table[i];
...
static bool
ez80_stub_is_required_for_16_bit_reloc (bfd_vma relocation)
{
...
static bfd_vma
ez80_get_stub_addr (bfd_vma srel,
                   struct elf32_ez80_link_hash_table *htab)
{
  unsigned int sindex;
...
ez80_final_link_relocate (reloc_howto_type *                 howto,
          bfd *                              input_bfd,
                         ...
                         struct elf32_ez80_link_hash_table * htab)
{
  ...
  switch (howto->type)
   ...
   return bfd_reloc_outofrange;
      ...
      srel = ez80_relative_distance_considering_wrap_around (srel);

      /* EZ80 addresses commands as words.  */
      srel >>= 1;
      ...
      if (srel < -2048 || srel > 2047)
   {
     ...
     /* Always apply WRAPAROUND for ez802, ez8025, and ez804.  */
     switch (bfd_get_mach (input_bfd))
       {
#if 0
       case bfd_mach_ez802:
       case bfd_mach_ez8025:
       case bfd_mach_ez804:
         break;
#endif
       default:
   ...
   return bfd_reloc_overflow;
    ...
    case R_EZ80_LO8_LDI_GS:
      use_stubs = (!htab->no_stubs);
      /* Fall through.  */
    case R_EZ80_LO8_LDI_PM:
      contents += rel->r_offset;
      srel = (bfd_signed_vma) relocation + rel->r_addend;

      if (use_stubs
          && ez80_stub_is_required_for_16_bit_reloc (srel - base_addr))
        {
          bfd_vma old_srel = srel;

          /* We need to use the address of the stub instead.  */
          srel = ez80_get_stub_addr (srel, htab);
          if (debug_stubs)
     ...
     if (ez80_stub_is_required_for_16_bit_reloc (srel - base_addr))
       return bfd_reloc_outofrange;
        }
   ...
   return bfd_reloc_outofrange;
    ...
    case R_EZ80_HI8_LDI_GS:
      use_stubs = (!htab->no_stubs);
      /* Fall through.  */
    case R_EZ80_HI8_LDI_PM:
      contents += rel->r_offset;
      srel = (bfd_signed_vma) relocation + rel->r_addend;
   ...
   return bfd_reloc_outofrange;
    ...
    /**
     * @brief Relocates a 24-bit little-endian absolute address field.
     */
    case R_EZ80_24:
      contents += rel->r_offset;
      srel = (bfd_signed_vma) relocation + rel->r_addend;
      x = contents[0] | (contents[1] << 8) | (contents[2] << 16);
      x += srel;
      contents[0] = x & 0xff;
      contents[1] = (x >> 8) & 0xff;
      contents[2] = (x >> 16) & 0xff;
      break;

    /**
     * @brief Relocates an 8-bit signed PC-relative offset.
     */
    case R_EZ80_8_PCREL:
      contents += rel->r_offset;
      srel = (bfd_signed_vma) relocation + rel->r_addend;
      srel -= reloc_addr;
      srel -= 1; /* Offset is relative to the next instruction */
      if (srel < -128 || srel > 127)
        return bfd_reloc_overflow;
      contents[0] = srel & 0xff;
      break;

    /**
     * @brief Relocates an 8-bit signed index displacement offset.
     */
    case R_EZ80_DISP8:
      contents += rel->r_offset;
      srel = (bfd_signed_vma) relocation + rel->r_addend;
             ...
             asection **local_sections)
{
  ...
  struct elf32_ez80_link_hash_table * htab = ez80_link_hash_table (info);
  ...
  for (rel = relocs; rel < relend; rel ++)
    {
      ...
      howto  = elf_ez80_howto_table + r_type;
      h      = NULL;
      sym    = NULL;
      sec    = NULL;
...
/* The final processing done just before writing out a EZ80 ELF object
...
bfd_elf_ez80_final_write_processing (bfd *abfd)
{
  ...
  switch (bfd_get_mach (abfd))
    ...
    default:
    case bfd_mach_ez802:
      val = E_EZ80_MACH_EZ802;
      break;

    case bfd_mach_ez801:
      val = E_EZ80_MACH_EZ801;
      break;

    case bfd_mach_ez8025:
      val = E_EZ80_MACH_EZ8025;
      break;

    case bfd_mach_ez803:
      val = E_EZ80_MACH_EZ803;
      break;

    case bfd_mach_ez8031:
      val = E_EZ80_MACH_EZ8031;
      break;

    case bfd_mach_ez8035:
      val = E_EZ80_MACH_EZ8035;
      break;

    case bfd_mach_ez804:
      val = E_EZ80_MACH_EZ804;
      break;

    case bfd_mach_ez805:
      val = E_EZ80_MACH_EZ805;
      break;

    case bfd_mach_ez8051:
      val = E_EZ80_MACH_EZ8051;
      break;

    case bfd_mach_ez806:
      val = E_EZ80_MACH_EZ806;
      break;

    case bfd_mach_ez80xmega1:
      val = E_EZ80_MACH_XMEGA1;
      break;

    case bfd_mach_ez80xmega2:
      val = E_EZ80_MACH_XMEGA2;
      break;

    case bfd_mach_ez80xmega3:
      val = E_EZ80_MACH_XMEGA3;
      break;

    case bfd_mach_ez80xmega4:
      val = E_EZ80_MACH_XMEGA4;
      break;

    case bfd_mach_ez80xmega5:
      val = E_EZ80_MACH_XMEGA5;
      break;

    case bfd_mach_ez80xmega6:
      val = E_EZ80_MACH_XMEGA6;
      break;

    case bfd_mach_ez80xmega7:
      val = E_EZ80_MACH_XMEGA7;
      break;
    }
#endif
  val = 0;

  elf_elfheader (abfd)->e_machine = EM_EZ80;
...
static bool
elf32_ez80_object_p (bfd *abfd)
{
  unsigned int e_set = bfd_mach_ez80;
#if 0
  if (elf_elfheader (abfd)->e_machine == EM_EZ80
      || elf_elfheader (abfd)->e_machine == EM_EZ80_OLD)
    {
      int e_mach = elf_elfheader (abfd)->e_flags & EF_EZ80_MACH;

      switch (e_mach)
   {
   default:
   case E_EZ80_MACH_EZ802:
     e_set = bfd_mach_ez802;
     break;

   case E_EZ80_MACH_EZ801:
     e_set = bfd_mach_ez801;
     break;

   case E_EZ80_MACH_EZ8025:
     e_set = bfd_mach_ez8025;
     break;

   case E_EZ80_MACH_EZ803:
     e_set = bfd_mach_ez803;
     break;

   case E_EZ80_MACH_EZ8031:
     e_set = bfd_mach_ez8031;
     break;

   case E_EZ80_MACH_EZ8035:
     e_set = bfd_mach_ez8035;
     break;

   case E_EZ80_MACH_EZ804:
     e_set = bfd_mach_ez804;
     break;

   case E_EZ80_MACH_EZ805:
     e_set = bfd_mach_ez805;
     break;

   case E_EZ80_MACH_EZ8051:
     e_set = bfd_mach_ez8051;
     break;

   case E_EZ80_MACH_EZ806:
     e_set = bfd_mach_ez806;
     break;

   case E_EZ80_MACH_XMEGA1:
     e_set = bfd_mach_ez80xmega1;
     break;

   case E_EZ80_MACH_XMEGA2:
     e_set = bfd_mach_ez80xmega2;
     break;

   case E_EZ80_MACH_XMEGA3:
     e_set = bfd_mach_ez80xmega3;
     break;

   case E_EZ80_MACH_XMEGA4:
     e_set = bfd_mach_ez80xmega4;
     break;

   case E_EZ80_MACH_XMEGA5:
     e_set = bfd_mach_ez80xmega5;
     break;

   case E_EZ80_MACH_XMEGA6:
     e_set = bfd_mach_ez80xmega6;
     break;

   case E_EZ80_MACH_XMEGA7:
     e_set = bfd_mach_ez80xmega7;
     break;
   }
    }
#endif
  return bfd_default_set_arch_mach (abfd, bfd_arch_ez80, e_set);
}
...
static bool
elf32_ez80_relax_delete_bytes (bfd *abfd,
                              asection *sec,
                              bfd_vma addr,
                              int count)
{
...
/* This function handles relaxing for the ez80.
...
static bool
elf32_ez80_relax_section (bfd *abfd,
          asection *sec,
                         ...
                         bool *again)
{
  ...
  htab = ez80_link_hash_table (link_info);
  if (htab == NULL)
    return false;
  ...
  *again = false;
  ...
  if ((!htab->no_stubs) && (sec == htab->stub_sec))
    ...
    Let's calculate the size needed again.  */
      ...
      elf32_ez80_size_stubs (htab->stub_sec->output_section->owner,
                            link_info, false);
  ...
  if (!(elf_elfheader (abfd)->e_flags & EF_EZ80_LINKRELAX_PREPARED))
    return true;
  ...
  for (irel = internal_relocs; irel < irelend; irel++)
    {
      ...
      if (   ELF32_R_TYPE (irel->r_info) != R_EZ80_13_PCREL
        && ELF32_R_TYPE (irel->r_info) != R_EZ80_7_PCREL
        && ELF32_R_TYPE (irel->r_info) != R_EZ80_CALL)
        continue;
   ...
   case R_EZ80_CALL:
          {
            ...
            /* Here we handle the wrap-around case.  E.g. for a 16k device
               ...
               vaiable ez80_pc_wrap_around with the appropriate value.
       ...
       typical value as safety margin.  */
         ...
         if (ez80_pc_wrap_around > 0x4000)
      assumed_shrink = 900;

         safety_margin = 2 * assumed_shrink;

         rgap = ez80_relative_distance_considering_wrap_around (gap);
            ...
            if (distance_short_enough)
              {
                ...
                if (!shrinkable)
                ...
                else
                  {
                    ...
                    if (!elf32_ez80_relax_delete_bytes (abfd, sec,
                                                       irel->r_offset + 2, 2))
                      goto error_return;
        ...
        default:
          {
            ...
            if (((code_msb & 0xf0) == 0xd0)
                && ez80_replace_call_ret_sequences)
              {
...
/* This is a version of bfd_generic_get_relocated_section_contents
   which uses elf32_ez80_relocate_section.

   For ez80 it's essentially a cut and paste taken from the H8300 port.
   The author of the relaxation support patch for ez80 had absolutely no
   clue what is happening here but found out that this part of the code
   seems to be important.  */

static bfd_byte *
elf32_ez80_get_relocated_section_contents (bfd *output_bfd,
                                          struct bfd_link_info *link_info,
                                          ...
                                          asymbol **symbols)
{
  ...
  if ((input_section->flags & SEC_RELOC) != 0
      && input_section->reloc_count > 0)
    {
      ...
      if (! elf32_ez80_relocate_section (output_bfd, link_info, input_bfd,
...
static char *
ez80_stub_name (const asection *symbol_section,
...
static struct elf32_ez80_stub_hash_entry *
ez80_add_stub (const char *stub_name,
              struct elf32_ez80_link_hash_table *htab)
{
  struct elf32_ez80_stub_hash_entry *hsh;

  /* Enter this entry into the linker stub hash table.  */
  hsh = ez80_stub_hash_lookup (&htab->bstab, stub_name, true, false);
...
static  bool
ez80_build_one_stub (struct bfd_hash_entry *bh, void *in_arg)
{
  struct elf32_ez80_stub_hash_entry *hsh;
  struct bfd_link_info *info;
  struct elf32_ez80_link_hash_table *htab;
  ...
  htab = ez80_link_hash_table (info);
  if (htab == NULL)
    return false;
...
static bool
ez80_mark_stub_not_to_be_necessary (struct bfd_hash_entry *bh,
...
static bool
ez80_size_one_stub (struct bfd_hash_entry *bh, void *in_arg)
{
  struct elf32_ez80_stub_hash_entry *hsh;
  struct elf32_ez80_link_hash_table *htab;
  int size;
...
void
elf32_ez80_setup_params (struct bfd_link_info *info,
                        bfd *ez80_stub_bfd,
                        asection *ez80_stub_section,
                        bool no_stubs,
                        bool deb_stubs,
                        bool deb_relax,
                        ...
                        bool call_ret_replacement)
{
  ...
  if (htab == NULL)
    return;
  htab->stub_sec = ez80_stub_section;
  htab->stub_bfd = ez80_stub_bfd;
  htab->no_stubs = no_stubs;

  debug_relax = deb_relax;
  debug_stubs = deb_stubs;
  ez80_pc_wrap_around = pc_wrap_around;
  ez80_replace_call_ret_sequences = call_ret_replacement;
}
...
int
elf32_ez80_setup_section_lists (bfd *output_bfd,
                               struct bfd_link_info *info)
{
  bfd *input_bfd;
  unsigned int bfd_count;
...
bool
elf32_ez80_size_stubs (bfd *output_bfd,
                      struct bfd_link_info *info,
                      bool is_prealloc_run)
{
  ...
  if (ADD_DUMMY_STUBS_FOR_DEBUGGING)
    {
      struct elf32_ez80_stub_hash_entry *test;

      test = ez80_add_stub ("Hugo",htab);
      test->target_value = 0x123456;
      test->stub_offset = 13;

      test = ez80_add_stub ("Hugo2",htab);
  ...
  while (1)
    {
           ...
           input_bfd = input_bfd->link.next, bfd_indx++)
        {
              ...
              for (; irela < irelaend; irela++)
                {
                  ...
                  /* Only look for 16 bit GS relocs. No other reloc will need a
                     stub.  */
                  if (!((r_type == R_EZ80_16_PM)
                        || (r_type == R_EZ80_LO8_LDI_GS)
                        || (r_type == R_EZ80_HI8_LDI_GS)))
                    continue;
            ...
            if (shndx < elf_numsections (input_bfd))
         {
           ...
           destination = (sym_value + irela->r_addend
                ...
                + sym_sec->output_section->vma);
                  ...
                  if (! ez80_stub_is_required_for_16_bit_reloc
         ...
         continue;
          ...
          Let's rather be on the safe side.  */
                  ...
                  stub_name = ez80_stub_name (sym_sec, sym_value, irela);

                  if (!stub_name)
                    goto error_ret_free_internal;


                  hsh = ez80_stub_hash_lookup (&htab->bstab,
                                              stub_name,
                                              false, false);
                  if (hsh != NULL)
                    {
                  ...
                  hsh = ez80_add_stub (stub_name, htab);
                  if (hsh == NULL)
                    {
                      free (stub_name);
                      goto error_ret_free_internal;
      ...
      bfd_hash_traverse (&htab->bstab, ez80_size_one_stub, htab);
...
bool
elf32_ez80_build_stubs (struct bfd_link_info *info)
{
  asection *stub_sec;
  struct bfd_hash_table *table;
  struct elf32_ez80_link_hash_table *htab;
  ...
  table = &htab->bstab;
  bfd_hash_traverse (table, ez80_build_one_stub, info);
...
#define ELF_ARCH     bfd_arch_ez80
#define ELF_TARGET_ID      EZ80_ELF_DATA
#define ELF_MACHINE_CODE   EM_EZ80
/* #define ELF_MACHINE_ALT1   EM_EZ80_OLD */
#define ELF_MAXPAGESIZE    1

/**
 * @brief Target configuration for the little-endian eZ80 ELF backend.
 */
#define TARGET_LITTLE_SYM  bfd_elf32_ez80_vec
...
#define elf_backend_relocate_section         elf32_ez80_relocate_section
#define elf_backend_can_gc_sections          1
#define elf_backend_rela_normal          1
#define elf_backend_final_write_processing \
               bfd_elf_ez80_final_write_processing
#define elf_backend_object_p     elf32_ez80_object_p

#define bfd_elf32_bfd_relax_section elf32_ez80_relax_section
#define bfd_elf32_bfd_get_relocated_section_contents \
                                        elf32_ez80_get_relocated_section_contents
