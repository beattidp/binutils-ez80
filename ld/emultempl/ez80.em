...
# to keep track of the machine type of EZ80 object files
...
LDEMUL_BEFORE_PARSE=gldez80_before_parse
LDEMUL_RECOGNIZED_FILE=gldez80_recognized_file
LDEMUL_AFTER_OPEN=gldez80_after_open

fragment <<EOF
/* --- \begin{ez80.em} */
/* Codes for machine types, bitwise or gives the code to use for the
   output.  */
#define M_EZ80STRICT 1
#define M_EZ80 3
#define M_EZ80FULL 7
#define M_R800 11
#define M_EZ80ANY 15
...
${LDEMUL_RECOGNIZED_FILE} (lang_input_statement_type *entry)
{
  ...
  switch (mach_type)
    {
    case bfd_mach_ez80strict:
      result_mach_type |= M_EZ80STRICT;
      break;
    case bfd_mach_ez80:
      result_mach_type |= M_EZ80;
      break;
    case bfd_mach_ez80full:
      result_mach_type |= M_EZ80FULL;
      break;
    case bfd_mach_r800:
...
gldez80_after_open (void)
{
  ...
  bfd_set_arch_mach (link_info.output_bfd, bfd_arch_ez80, mach_type);
}
/* --- \end{ez80.em} */
EOF
